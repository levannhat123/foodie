...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/food_2.png
  AssetGenImage get food2 => const AssetGenImage('assets/images/food_2.png');

  /// File path: assets/images/food_3.png
  AssetGenImage get food3 => const AssetGenImage('assets/images/food_3.png');

  /// File path: assets/images/kristen_stewart.jpg
  AssetGenImage get kristenStewart =>
      const AssetGenImage('assets/images/kristen_stewart.jpg');
  ...
  /// File path: assets/images/radio_button_on.png
  AssetGenImage get radioButtonOn =>
      const AssetGenImage('assets/images/radio_button_on.png');

  /// File path: assets/images/time_icon.png
  AssetGenImage get timeIcon =>
      const AssetGenImage('assets/images/time_icon.png');
